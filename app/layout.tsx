...
export const metadata: Metadata = {
	...
	authors: [{ name: 'John Tolentino' }],
	creator: 'John Tolentino',
	openGraph: {
		...
		images: [
			{
				...
				width: 1200,
				height: 630,
				alt: 'John Tolentino - Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
	...
	return (
		<html lang="en">
			...
			<body className={`${geistSans.variable} ${geistMono.variable} antialiased`}>
				<main>{children}</main>
				<GoogleTagManager gtmId="GTM-MP9KJGQM" />
				<GoogleTagManager gtmId="G-S6D9PB6G07" />
			</body>
		</html>
	);
}
